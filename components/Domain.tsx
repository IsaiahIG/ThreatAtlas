...
export default function Domain() {
  ...
  const [lastSearchedDomain, setLastSearchedDomain] = useState("");
  ...
  async function runLookup() {
    ...
    try {
      ...
      const fetchPromise = (async () => {
        const res = await fetch(`/api/vt/domain?domain=${encodeURIComponent(value)}`, {
          method: "GET",
          cache: "no-store",
        });
